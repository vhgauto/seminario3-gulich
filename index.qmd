...
```{r}
plotRGB(mt, main = "Las Heras, Mendoza", mar = c(0, 0, 1.4, 0))
# anotación, texto
text(
  ac,
  labels = "Aconcagua (6960 m)",
...
lines(lh_v, col = "white", lty = 1)
lines(lh_v, col = "black", lty = 2)
# brújula
north(
  xy = "topright",
  type = 2,
...
# anotación, punto
points(ac, pch = 24, cex = 1, col = "black", bg = "gold")
points(lh, pch = 21, cex = 1, col = "black", bg = "gold")
```
...
ggplot() +
  ...
  annotation_scale(location = "bl", text_col = "white") +
  labs(
...
- [ggiraph](https://davidgohel.github.io/ggiraph/) ![](https://davidgohel.github.io/ggiraph/reference/figures/logo.png){height=60}

- [terra](https://rspatial.github.io/terra/) ![](https://rspatial.github.io/terra/logo.png){height=60}

- [leaflet](https://rstudio.github.io/leaflet/) ![](https://leafletjs.com/docs/images/logo.png){height=60}

- [tmap.mapgl](https://r-tmap.github.io/tmap/index.html) ![](https://r-tmap.github.io/tmap.mapgl/logo.png){height=60}

- [mapgl](https://walker-data.com/mapgl/) ![](https://walker-data.com/mapgl/logo.png){height=60}
