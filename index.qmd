...
Maps as figures (`.png`) to use in publications, posters, social media and news.
...
Elevation from <b>Las Heras</b> department in Mendoza province to demostrate different packages and results.
...
Real color from <b>Las Heras</b> department in Mendoza province to demostrate different packages and results.
...
Used to indicate change, evolution in time and progress.
...
Monthly mean temperature, from 1970 to 2000, Las Heras Department, Mendoza Province.
...
Maps were the user can play, zoom in/out, click and hover with the mouse. Usually found in web sites and mobile apps.
...
Argentina map with provinces division and names.
